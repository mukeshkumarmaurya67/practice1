...
const Gallerys = () => {
  ...
  return (
    ...
    <>
        ...
        <div className='row'>
          <div className='col-lg-4 col-md-6'>
            <div className="galaryrow2-content">
              ...
              <p class='galaryrow2-p'>CONTENT-1</p>
            </div>
          </div>
          ...
          <div className='col-lg-4 col-md-6 viewmore-btn'>
            <div type="button" >
                <p class='galaryrow2-p text-dark' id='viewmore-btn' onClick={() => { mdisp(); intervalscroll(); }}>
                  View-More
                </p>
            </div>
          </div>
      ...
      <div className='container mt-5' style={{ backgroundColor: 'rgb(240, 240, 240)', height: '690px' }}>
        <div className='row'>
        ...
        <div className='row '>
          ...
          <div className='col-lg-4 col-sm-12 gl'>
            <div className='galaryrow3-item2'>
             <h5>Lorem  minim consequat in sit.Adipisicing et aliquip</h5>
             <p>Reprehenderit duis nisi labore ad elit amet sunt.Occaecat aliqua aliqua consectetur id veniam.</p>
