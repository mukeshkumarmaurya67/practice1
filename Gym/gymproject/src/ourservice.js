...
return (
<>
<section className="our-services blue-background">
   <div className="container">
      <h2 className="text-warning mb-5 main-title-h2">
         <span className="text-light ">OUR </span>Services
      </h2>
      <div className="row">
         <div className="col-lg-6 col-md-6 col-12">
            <div className="our-services-img">
               <img src={img7} height="250" width="450" />
            </div>
         </div>
         <div className="col-lg-6 col-md-6 col-12">
            <p className="mt-3">
...
<section className="our-facility blue-background">
   <h3 className="main-title-h2 text-warning">Our <span className="text-light">Facilities</span></h3>
   <div className="row">
...
<section className="our-goal blue-background">
   <div className="container">
   ...
   <div className="col-lg-6 text-center">
      <p className="text-light" id="discriptions1"> <b className="text-info"> It’s important </b>to reassess your business goals at the
         ...
         business goals
         and often their business models to pivot towards digital delivery of services.<br/>
         if you survey <b className="text-info text-decoration-underline">all the female members</b> of your gym and find out that a significant percentage don’t feel comfortable
