...
<>
{/* reach-fitness-goal */}
<section className="fitness-goal blue-background mt-4">
   <div className='container  main-title-h1 '>
      <h1 className="text-warning">Reach <span className="text-light">Your</span> <span className="text-light">
      ...
      <div className="row">
         <div className="col-lg-6 fitness-goal-order">
            <div className="fitness-goal-left-content">
               ...
               <p><a className="blue-button" href="#" onClick={mdisplay}>Register Now</a></p>
         ...
         <div className="col-lg-6 ">
            <div className="fitness-goal-right-content">
